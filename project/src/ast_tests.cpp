...
public:
 TestDescription_AstTestSuite_test_ast_squareMapper() : CxxTest::RealTestDescription( Tests_AstTestSuite, suiteDescription_AstTestSuite, 31, "test_ast_squareMapper" ) {}
...
public:
 TestDescription_AstTestSuite_test_ast_abstar() : CxxTest::RealTestDescription( Tests_AstTestSuite, suiteDescription_AstTestSuite, 71, "test_ast_abstar" ) {}
...
public:
 TestDescription_AstTestSuite_test_ast_box() : CxxTest::RealTestDescription( Tests_AstTestSuite, suiteDescription_AstTestSuite, 110, "test_ast_box" ) {}
...
public:
 TestDescription_AstTestSuite_test_ast_sumOfSquares() : CxxTest::RealTestDescription( Tests_AstTestSuite, suiteDescription_AstTestSuite, 149, "test_ast_sumOfSquares" ) {}
